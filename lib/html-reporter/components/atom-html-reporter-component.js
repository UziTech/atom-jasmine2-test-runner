				...
				<div className='top-header'>
					...
					<span className='float-right'>
						<span className='collapser-links'>
							...
							|
							<a href='#' onclick={this.uncollapseAll}>Uncollapse All</a>
							]
						</span>
						<Octicon icon='sync' className='reload' onclick={this.handleRefreshClick}/>{/* todo: fix this */}
					</span>
				</div>
				<Dots tests={this.props.tests}/>
				<StatusLine status={this.props.status} label={this.props.label} totalNumber={this.props.testsToRun} numberRan={this.props.testsRan} numberSkipped={this.props.testsSkipped} startTime={this.props.startTime} endTime={this.props.endTime}/>
				{this.props.testTitle ? <div className='current-test'>Running test: {this.props.testTitle}</div> : <noscript/>}
				<TestFailures tests={this.props.tests}/>
